...
const Bandits: Bandit[] = [
    ...
    Status: "Wanted", 
    Photo: "../assets/silber_bandit.JPEG" },
    ...
    Status: "Wanted",
    Photo: "../assets/yarrington_bandit.JPEG"
    },
    {Name: "Nasty Nazim",
    threatLevel: 3,
    ...
    Status: "Wanted",
    Photo: "../assets/nazim_bandit.JPEG"
    },
    {Name: "Ride ‘em Roosen",
    threatLevel: 2,
    ...
    Status: "Wanted",
    Photo: "../assets/roosen_bandit.JPEG"
    },
    {
        Name: "Macho MattSap",
        threatLevel: 1,
        ...
        Status: "Caught",
        Photo: "../assets/mattsap_bandit.JPEG"
    },
    {
        Name: "Lucky Liao",
        threatLevel: 3,
